...
class EncoderDecoderUnitTest {
    ...
    fun test1() {
        ...
        val case1Encoding1 =
            URI(null, null, case1FilePath, null).toString()    // OEBPS/Text/Chapter%201.html
        val case1Encoding2 =
            URLEncoder.encode(case1FilePath, "UTF-8")   // OEBPS%2FText%2FChapter+1.html
        ...
        val case2LinkHref =
            "/OEBPS/Text/%E4%BA%B2%E5%AD%902018%E5%B9%B44%E6%9C%88%E5%88%8A_0001.xhtml"
        val case2Decoding1 = URI(
            null,
            null,
            case2LinkHref,
            null
        ).toString()    // /OEBPS/Text/%25E4%25BA%25B2%25E5%25AD%25902018%25E5%25B9%25B44%25E6%259C%2588%25E5%2588%258A_0001.xhtml
        val case2Decoding2 =
            URLDecoder.decode(case2LinkHref, "UTF-8")   // /OEBPS/Text/亲子2018年4月刊_0001.xhtml
        ...
        val case3LinkHref =
            "/OEBPS/Text/%D8%A7%D9%84%D9%85%D8%A7%D8%B6%D9%8A%20%D9%88%D8%A7%D9%84%D9%85%D8%B3%D8%AA%D9%82%D8%A8%D9%84.html"
        val case3Decoding1 = URI(
            null,
            null,
            case3LinkHref,
            null
        ).toString()    // /OEBPS/Text/%25D8%25A7%25D9%2584%25D9%2585%25D8%25A7%25D8%25B6%25D9%258A%2520%25D9%2588%25D8%25A7%25D9%2584%25D9%2585%25D8%25B3%25D8%25AA%25D9%2582%25D8%25A8%25D9%2584.html
        val case3Decoding2 =
            URLDecoder.decode(case3LinkHref, "UTF-8")   // /OEBPS/Text/الماضي والمستقبل.html
