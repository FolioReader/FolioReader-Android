...
public class ContentHighlightActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        if (mIsNightMode) {
            ...
            findViewById(R.id.btn_contents).setBackgroundDrawable(UiUtil.convertColorIntoStateDrawable(mConfig.getThemeColor(), ContextCompat.getColor(this, R.color.black)));
            findViewById(R.id.btn_highlights).setBackgroundDrawable(UiUtil.convertColorIntoStateDrawable(mConfig.getThemeColor(), ContextCompat.getColor(this, R.color.black)));
            ...
            findViewById(R.id.btn_contents).setBackgroundDrawable(UiUtil.convertColorIntoStateDrawable(mConfig.getThemeColor(), ContextCompat.getColor(this, R.color.white)));
            findViewById(R.id.btn_highlights).setBackgroundDrawable(UiUtil.convertColorIntoStateDrawable(mConfig.getThemeColor(), ContextCompat.getColor(this, R.color.white)));
        }
