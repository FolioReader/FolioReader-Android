...
public class EnglishDictionaryAdapter extends RecyclerView.Adapter<EnglishDictionaryAdapter.DictionaryHolder> {

    private List<EnglishDictionaryResults> results;
